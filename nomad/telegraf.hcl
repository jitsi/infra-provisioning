...
[[inputs.prometheus]]
  ...
  [inputs.prometheus.consul]
    ...
    [[inputs.prometheus.consul.query]]
      name = "grouch"
      tag = "ip-{{ env "attr.unique.network.ip-address" }}"
      url = 'http://{{"{{"}}if ne .ServiceAddress ""}}{{"{{"}}.ServiceAddress}}{{"{{"}}else}}{{"{{"}}.Address}}{{"{{"}}end}}:{{"{{"}}with .ServiceMeta.http}}{{"{{"}}.}}{{"{{"}}else}}{{"{{"}}.ServicePort}}{{"{{"}}end}}/{{"{{"}}with .ServiceMeta.metrics_path}}{{"{{"}}.}}{{"{{"}}else}}metrics{{"{{"}}end}}'
      [inputs.prometheus.consul.query.tags]
        host = "{{"{{"}}.Node}}"
        service = "grouch"
    [[inputs.prometheus.consul.query]]
...
[[inputs.prometheus]]
  namepass = [
    ...
    "jitsi_jvb_jvm_*",
    "jitsi_jvb_keyframe_budget_wait_milliseconds_api_total",
    "jitsi_jvb_keyframe_budget_wait_milliseconds_total",
    "jitsi_jvb_keyframe_budget_waits_api_total",
    "jitsi_jvb_keyframe_budget_waits_total",
    "jitsi_jvb_keyframe_requests_dropped_by_budget_api_total",
    "jitsi_jvb_keyframe_requests_dropped_by_budget_total",
    "jitsi_jvb_keyframes_received_total",
    "jitsi_jvb_largest_conference",
    "jitsi_jvb_layer_switch_keyframe_wait_milliseconds_total",
    "jitsi_jvb_layer_switch_keyframe_waits_completed_total",
    "jitsi_jvb_layer_switch_keyframe_waits_in_progress",
