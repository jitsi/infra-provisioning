...
- name: system_alerts
  ...
  - alert: System_CPU_Usage_High
    ...
    labels:
      ...
      severity: critical
    annotations:
      summary: host in ${var.dc} has had CPU usage > 70% for 5 minutes
      description: host in ${var.dc} has had a CPU running at over 70% in the last 5 minutes. It was most recently at {{ $value }}.
