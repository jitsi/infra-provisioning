...
[[ end -]]
    ...
    task "signal-sidecar" {
      ...
      config {
        ...
        labels {
          release = "[[ env "CONFIG_release_number" ]]"
          version = "[[ env "CONFIG_signal_sidecar_tag" ]]"
        }
      }
...
XMPP_MODULES="
[[- if eq (or (env "CONFIG_prosody_enable_system_chat_message") "false") "true" ]]system_chat_message,[[ end -]]
...
[[- if eq (or (env "CONFIG_prosody_brewery_shard_enabled") "true") "true" ]]
    task "prosody-jvb" {
      ...
      env {
        ...
        GLOBAL_CONFIG = "component_admins_as_room_owners=true;\nconsole_ports={ 6582 };\nstatistics = \"internal\";\nstatistics_interval = \"manual\";\nopenmetrics_allow_cidr = \"0.0.0.0/0\";\ndebug_traceback_filename = \"traceback.txt\";\nc2s_stanza_size_limit = 10*1024*1024;\n"
