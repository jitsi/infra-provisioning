...
job "jibri" {
  ...
  datacenters = ["lonely-us-phoenix-1"]
  ...
  group "jibri" {
    ...
    task "jibri" {
      ...
      env {
        ...
        XMPP_INTERNAL_MUC_DOMAIN = "internal.${var.domain}"
...
{{- range service "${var.domain}.prosody-client" }}
XMPP_SERVER={{ .Address }}
XMPP_PORT={{ .Port }}
{{ end }}
  ...
  group "jibri" {
    ...
    task "main" {
      ...
      env {
        ...
        PUBLIC_URL = "https://aaron-jibri.jitsi.net"
        DB_PASS = "loremipsum"
      }
