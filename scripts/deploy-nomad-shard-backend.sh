...
[ -z "$SIGNAL_SIDECAR_IMAGE" ] && SIGNAL_SIDECAR_IMAGE="jitsi/signal-sidecar"
[ -z "$SIGNAL_SIDECAR_IMAGE_TAG" ] && SIGNAL_SIDECAR_IMAGE_TAG="0.0.10"
...
export CONFIG_signal_sidecar_image="$SIGNAL_SIDECAR_IMAGE"
