...
export NOMAD_VAR_compartment_id="${COMPARTMENT_OCID}"
export NOMAD_VAR_vcn_id="${VCN_ID}"

JOB_NAME="csi-$ORACLE_REGION"

sed -e "s/\[JOB_NAME\]/$JOB_NAME/" "$NOMAD_JOB_PATH/oci-csi-server.hcl" | nomad job run -
