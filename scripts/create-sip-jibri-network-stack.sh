...
[ -z "$SIP_JIBRI_SUBNET_A_CIDR" ] && SIP_JIBRI_SUBNET_A_CIDR=$DEFAULT_SIP_JIBRI_SUBNET_A_CIDR
[ -z "$SIP_JIBRI_SUBNET_B_CIDR" ] && SIP_JIBRI_SUBNET_B_CIDR=$DEFAULT_SIP_JIBRI_SUBNET_B_CIDR

[ -z "$SIP_JIBRI_SUBNET_A_CIDRS_IPV6" ] && SIP_JIBRI_SUBNET_A_CIDRS_IPV6=$DEFAULT_SIP_JIBRI_SUBNET_A_CIDRS_IPV6
[ -z "$SIP_JIBRI_SUBNET_B_CIDRS_IPV6" ] && SIP_JIBRI_SUBNET_B_CIDRS_IPV6=$DEFAULT_SIP_JIBRI_SUBNET_B_CIDRS_IPV6

[ -z "$SIP_JIBRI_SUBNET_A_CIDRS_IPV6" ] && SIP_JIBRI_SUBNET_A_CIDRS_IPV6="07::/64"
[ -z "$SIP_JIBRI_SUBNET_B_CIDRS_IPV6" ] && SIP_JIBRI_SUBNET_B_CIDRS_IPV6="08::/64"
...
[ -z "$SIP_JIBRI_SUBNET_AWS_PUBLIC_IPS" ] && SIP_JIBRI_SUBNET_AWS_PUBLIC_IPS="false"
...
[ -z $STACK_NAME ] && STACK_NAME="${REGION_ALIAS}-${STACK_NAME_PREFIX}-sip-jibri-network"

#required 8x8 tag
[ -z "$SERVICE" ] && SERVICE="jitsi-sip-jibri-network"
...
[ -z $CF_TEMPLATE_JSON ] && CF_TEMPLATE_JSON="/tmp/vaas-network-sip-jibri.template.json"
...
$LOCAL_PATH/../templates/create_network_sip_jibri_template.py --region "$EC2_REGION" --regionalias "$REGION_ALIAS" --stackprefix "$CLOUD_PREFIX" --filepath $CF_TEMPLATE_JSON \
...
ParameterKey=SubnetMapPublicIp,ParameterValue="$SIP_JIBRI_SUBNET_AWS_PUBLIC_IPS" \
ParameterKey=SubnetACidr,ParameterValue=\"$SIP_JIBRI_SUBNET_A_CIDR\" \
ParameterKey=SubnetBCidr,ParameterValue=\"$SIP_JIBRI_SUBNET_B_CIDR\" \
ParameterKey=SubnetACidrIPv6,ParameterValue="$SIP_JIBRI_SUBNET_A_CIDRS_IPV6" \
ParameterKey=SubnetBCidrIPv6,ParameterValue="$SIP_JIBRI_SUBNET_B_CIDRS_IPV6" \
...
"Key=stack-role,Value=sip-jibri-network" \
