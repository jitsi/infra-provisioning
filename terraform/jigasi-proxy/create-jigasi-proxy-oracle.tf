...
variable "user_data_file" {
  default = "terraform/jigasi-proxy/user-data/postinstall-runner-oracle.sh"
}
...
resource "oci_dns_rrset" "jigasi_proxy_dns_record" {
